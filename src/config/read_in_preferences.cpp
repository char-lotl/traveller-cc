...
const std::string PROMPTS[NUM_PHASES] = {
	...
	[ALLOW_HOMEWORLD_REROLL] = "ALLOW_HOMEWORLD_REROLL",
...
const int RULES_IN_ORDER[NUM_PHASES] = {
	...
	[ALLOW_HOMEWORLD_REROLL] = rule_type::ALLOW_HOMEWORLD_REROLL
};
...
const LineType LINE_TYPES_IN_ORDER[NUM_PHASES] = {
	...
	[ALLOW_HOMEWORLD_REROLL] = LineType::LINE_TOGGLE_RULE,
...
// the toggle_rule_type and int_rule_type enums, as well as pref.cfg.
